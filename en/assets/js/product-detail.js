...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function loadProductDetail(slug) {
    fetch(`${API_BASE}/products/en/slug?slug=${slug}`)
      .then(res => {
    ...
    fetch(`${API_BASE}/products?limit=4`)
      ...
      .then(result => {
        ...
        if (products.length === 0) {
          list.innerHTML = '<p>No similar products available.</p>';
          return;
        }
          ...
          <li class="splide__slide">
            <div class="card">
              ...
              <div class="card__body">
                ...
                <a href="/en/product-detail.html?slug=${product.slug || ''}" class="btn btn--primary btn--sm">See the product</a>
              </div>
            </div>
          </li>
        `).join('');
