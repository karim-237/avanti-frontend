          ...
          <li class="splide__slide">
            <div class="card">
              ...
              <div class="card__body">
                ...
                <a href="product-detail.html?slug=${product.slug || ''}" class="btn btn--primary btn--sm" style="margin-top: auto;">View product</a> 
              </div>
            </div>
          </li>
        `;
        ...
        grid.innerHTML = recipes.map(recipe => {
          ...
          <div class="recipe-card">
            ...
            <div class="recipe-card__body">
              ...
              <a href="single-recipe.html?slug=${recipe.slug || ''}" class="btn btn--secondary btn--sm">See the recipe</a>
            </div>
          </div>
        `;
        }).join('');
        ...
        grid.innerHTML = posts.map(post => {
          ...
          <div class="blog-card">
            ...
            <div class="blog-card__body">
              ...
              <a href="single-blog.html?slug=${post.slug || ''}" class="btn btn--primary btn--sm">Read the article</a>
            </div>
          </div>
        `;
        }).join('');
