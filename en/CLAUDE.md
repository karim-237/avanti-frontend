...
### Loading States
HTML includes "Loading..." (Loading) text as placeholders, replaced when API data arrives.

### Localization
All dates formatted with French locale: `toLocaleDateString('en-EN')`. UI text is in French.
