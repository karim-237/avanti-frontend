...
```javascript
if (window.location.pathname.includes("single-/fr/blog.html")) {
...
### Core Pages
- `/fr/index.html` - Homepage with hero carousel, featured products, testimonials
- `/fr/products.html` - Product catalog with category filtering
- `product-detail.html` - Individual product (uses `?slug=` parameter)
- `/fr/blog.html` - Blog listing with category tabs
- `single-/fr/blog.html` - Blog post detail (uses `?slug=` parameter)
- `/fr/recette.html` - Recipe listings by category
- `single-recipe.html` - Recipe detail (uses `?slug=` parameter)
- `/fr/about.html` - Company information with statistics
- `/fr/contact.html` - Contact form with validation

### Utility Pages
- `coming-soon.html` - Maintfrance mode redirect target
- `404.html` - Error page
- `faq.html` - Frequently asked questions
- Policy pages: `privacy-policy.html`, `cookie-policy.html`, `/fr/term-of-use.html`
