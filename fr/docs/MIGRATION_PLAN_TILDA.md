...
- **Navigation:** Accueil, À propos, Nos produits, Blog, Recettes, Contacts
...
- ✅ Remplacer menu actuel par:
  - **Shop** (lien vers /fr/products.html)
  - **Product Ranges** (lien vers /fr/products.html#ranges)
  - **Recipes** (lien vers /fr/recette.html)
...
### **PHASE 3 - HOMEPAGE (/fr/index.html)**

#### 3.1 Hero Carousel
**Fichier:** `/fr/index.html`, `/fr/assets/js/carousel.js`
...
**Fichier:** `/fr/index.html`, `/fr/assets/api/global.js`
...
- ✅ 2-3 articles featured avec:
  ...
  - Category tag
  - Titre article
  - Date publication (format français)
  - Description courte
  - Lien vers single-/fr/blog.html
...
- ✅ Lien "Lire Plus" vers /fr/about.html
...
**Fichier:** `/fr/index.html`, `/fr/assets/js/contact-form.js`
...
**Fichier:** `/fr/products.html`

**Actions:**
- ✅ Hero titre: "Tilda Products"
- ✅ Tab selector: "All Products" actif (par défaut)
- ✅ Tab "Shop" (lien vers /fr/products.html?view=shop)

#### 4.2 Circular Category Cards
**Fichier:** `/fr/products.html`, `/fr/assets/css/shop.css`
...
### **PHASE 5 - SHOP PAGE (/fr/products.html avec filtres)**
...
**Fichier:** `/fr/products.html`, `/fr/assets/js/filter-button.js`
...
#### 7.1 Hero
**Fichier:** `/fr/recette.html`, `/fr/assets/css/blog.css`
...
#### 9.1 Hero
**Fichier:** `/fr/blog.html`, `/fr/assets/css/blog.css`
...
**Fichier:** `/fr/blog.html`, `/fr/assets/api/global.js`
...
**Fichier:** `single-/fr/blog.html`, `/fr/assets/css/blog.css`
...
**Fichier:** `/fr/about.html`, `/fr/assets/css/sections/about.css` (nouveau)
...
**Fichier:** `/fr/contact.html`, `/fr/assets/css/sections/contact.css` (nouveau)
...
**Fichier:** `/fr/contact.html`, `/fr/assets/js/contact-form.js`
...
**Actions:**
- ✅ Tabs "Shop" vs "All Products" (/fr/products.html)
- ✅ Tabs "Recipes" vs "Meal Planner" (/fr/recette.html)
- ✅ Tabs Blog categories (/fr/blog.html)
...
### Contenu
- Traduire tous les textes en français (UI actuelle en français)
- Vérifier dates format français (`toLocaleDateString('fr-FR')`)
